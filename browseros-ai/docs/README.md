...
- `architecture.md`: system architecture and component interaction map.
- `installation.md`: environment and build setup.
- `developer_guide.md`: workflow, CI/CD baseline, and security checklist.
